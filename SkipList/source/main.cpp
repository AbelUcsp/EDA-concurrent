...
void TestSequential() {
            ...
            << "====================================" << std::endl;
  {
    ...
    //ADE::Concurrent::ConcurrentSkipList<int> test;
    //sisi, le debes colocar así lista.insert(ObjectInt(num_iter))
    ...
    std::cout << "counter: "<< IntWithObjCounter::counter << std::endl;  // sentinelas left y right
  }
...
class ListTester {
 ...
 public:
  ...
  void operator()() {
    static const double CONTAINS_WEIGHT = 0.2;  //2
    static const double INSERT_WEIGHT = 0.7;  //7
...
/*
 ...
 private:
  ...
  static std::uniform_real_distribution<double> 
      sample_01_;
  static std::uniform_real_distribution<unsigned int> 
      random_;
...
int main() {
  ...
  for (int i = 0; i < trials; ++i) {
    std::cerr << "Running test case " << i << std::endl;
    RunTest(i == trials - 1);
  }*/
